            ...
            if ("IN".equalsIgnoreCase(op)) {
                ...
                if (items != null) {
                    ...
                    for (Object item : items) {
                        ...
                        if (com.lidroid.xutils.db.sqlite.ColumnDbType.TEXT.equals(ColumnConverterFactory.getDbColumnType(itemColValue.getClass()))) {
                ...
                if (items != null) {
                    ...
                    if (com.lidroid.xutils.db.sqlite.ColumnDbType.TEXT.equals(ColumnConverterFactory.getDbColumnType(startColValue.getClass()))) {
                ...
                if (com.lidroid.xutils.db.sqlite.ColumnDbType.TEXT.equals(ColumnConverterFactory.getDbColumnType(value.getClass()))) {
