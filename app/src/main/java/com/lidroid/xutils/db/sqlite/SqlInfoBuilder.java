...
public class SqlInfoBuilder {
    ...
    public static com.lidroid.xutils.db.sqlite.SqlInfo buildInsertSqlInfo(DbUtils db, Object entity) throws DbException {

        List<KeyValue> keyValueList = entity2KeyValueList(db, entity);
        if (keyValueList.size() == 0) return null;

        com.lidroid.xutils.db.sqlite.SqlInfo result = new com.lidroid.xutils.db.sqlite.SqlInfo();
    ...
    public static com.lidroid.xutils.db.sqlite.SqlInfo buildReplaceSqlInfo(DbUtils db, Object entity) throws DbException {
    ...
    public static com.lidroid.xutils.db.sqlite.SqlInfo buildDeleteSqlInfo(DbUtils db, Object entity) throws DbException {
        com.lidroid.xutils.db.sqlite.SqlInfo result = new com.lidroid.xutils.db.sqlite.SqlInfo();
        ...
        sb.append(" WHERE ").append(com.lidroid.xutils.db.sqlite.WhereBuilder.b(id.getColumnName(), "=", idValue));
    ...
    public static com.lidroid.xutils.db.sqlite.SqlInfo buildDeleteSqlInfo(DbUtils db, Class<?> entityType, Object idValue) throws DbException {
        com.lidroid.xutils.db.sqlite.SqlInfo result = new com.lidroid.xutils.db.sqlite.SqlInfo();
    ...
    public static com.lidroid.xutils.db.sqlite.SqlInfo buildDeleteSqlInfo(DbUtils db, Class<?> entityType, com.lidroid.xutils.db.sqlite.WhereBuilder whereBuilder) throws DbException {
        Table table = Table.get(db, entityType);
        StringBuilder sb = new StringBuilder(buildDeleteSqlByTableName(table.tableName));
        ...
        return new com.lidroid.xutils.db.sqlite.SqlInfo(sb.toString());
    }

    //*********************************************** update sql ***********************************************

    public static com.lidroid.xutils.db.sqlite.SqlInfo buildUpdateSqlInfo(DbUtils db, Object entity, String... updateColumnNames) throws DbException {
        ...
        sqlBuffer.deleteCharAt(sqlBuffer.length() - 1);
        sqlBuffer.append(" WHERE ").append(com.lidroid.xutils.db.sqlite.WhereBuilder.b(id.getColumnName(), "=", idValue));

        result.setSql(sqlBuffer.toString());
        return result;
    }

    public static com.lidroid.xutils.db.sqlite.SqlInfo buildUpdateSqlInfo(DbUtils db, Object entity, com.lidroid.xutils.db.sqlite.WhereBuilder whereBuilder, String... updateColumnNames) throws DbException {
    ...
    public static com.lidroid.xutils.db.sqlite.SqlInfo buildCreateTableSqlInfo(DbUtils db, Class<?> entityType) throws DbException {
        Table table = Table.get(db, entityType);
        Id id = table.id;
