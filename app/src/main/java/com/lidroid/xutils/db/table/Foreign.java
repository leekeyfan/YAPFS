...
public class Foreign extends com.lidroid.xutils.db.table.Column {
            ...
            if (columnType.equals(ForeignLazyLoader.class)) {
                ...
                try {
                    ...
                    if (foreignEntities.size() > 0) {
                        ...
                        com.lidroid.xutils.db.table.Column column = TableUtils.getColumnOrId(foreignEntityType, foreignColumnName);
                        columnValue = column.getColumnValue(foreignEntities.get(0));

                        // 仅自动关联外键
                        com.lidroid.xutils.db.table.Table table = this.getTable();
                        if (table != null && column instanceof com.lidroid.xutils.db.table.Id) {
                ...
                try {
                    com.lidroid.xutils.db.table.Column column = TableUtils.getColumnOrId(columnType, foreignColumnName);
