...
public class ColumnConverterFactory {
    ...
    public static com.lidroid.xutils.db.converter.ColumnConverter getColumnConverter(Class columnType) {
        ...
        } else if (com.lidroid.xutils.db.converter.ColumnConverter.class.isAssignableFrom(columnType)) {
            try {
                com.lidroid.xutils.db.converter.ColumnConverter columnConverter = (com.lidroid.xutils.db.converter.ColumnConverter) columnType.newInstance();
    ...
    public static ColumnDbType getDbColumnType(Class columnType) {
        com.lidroid.xutils.db.converter.ColumnConverter converter = getColumnConverter(columnType);
        if (converter != null) {
    ...
    public static void registerColumnConverter(Class columnType, com.lidroid.xutils.db.converter.ColumnConverter columnConverter) {
        columnType_columnConverter_map.put(columnType.getName(), columnConverter);
    }
    ...
    private static final ConcurrentHashMap<String, com.lidroid.xutils.db.converter.ColumnConverter> columnType_columnConverter_map;

    static {
        columnType_columnConverter_map = new ConcurrentHashMap<String, com.lidroid.xutils.db.converter.ColumnConverter>();

        com.lidroid.xutils.db.converter.BooleanColumnConverter booleanColumnConverter = new BooleanColumnConverter();
        ...
        com.lidroid.xutils.db.converter.ByteColumnConverter byteColumnConverter = new ByteColumnConverter();
        columnType_columnConverter_map.put(byte.class.getName(), byteColumnConverter);
        columnType_columnConverter_map.put(Byte.class.getName(), byteColumnConverter);

        com.lidroid.xutils.db.converter.CharColumnConverter charColumnConverter = new CharColumnConverter();
        ...
        com.lidroid.xutils.db.converter.DateColumnConverter dateColumnConverter = new DateColumnConverter();
        columnType_columnConverter_map.put(Date.class.getName(), dateColumnConverter);

        com.lidroid.xutils.db.converter.DoubleColumnConverter doubleColumnConverter = new DoubleColumnConverter();
        columnType_columnConverter_map.put(double.class.getName(), doubleColumnConverter);
        columnType_columnConverter_map.put(Double.class.getName(), doubleColumnConverter);

        com.lidroid.xutils.db.converter.FloatColumnConverter floatColumnConverter = new FloatColumnConverter();
        ...
        com.lidroid.xutils.db.converter.LongColumnConverter longColumnConverter = new LongColumnConverter();
        columnType_columnConverter_map.put(long.class.getName(), longColumnConverter);
        columnType_columnConverter_map.put(Long.class.getName(), longColumnConverter);

        com.lidroid.xutils.db.converter.ShortColumnConverter shortColumnConverter = new ShortColumnConverter();
        ...
        com.lidroid.xutils.db.converter.StringColumnConverter stringColumnConverter = new StringColumnConverter();
