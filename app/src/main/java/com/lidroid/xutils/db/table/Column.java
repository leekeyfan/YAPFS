...
public class Column {
    ...
    private com.lidroid.xutils.db.table.Table table;
    ...
    public com.lidroid.xutils.db.table.Table getTable() {
        return table;
    }

    /* package */ void setTable(com.lidroid.xutils.db.table.Table table) {
        this.table = table;
    }
