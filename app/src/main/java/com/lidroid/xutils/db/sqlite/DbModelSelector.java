...
public class DbModelSelector {
    ...
    private com.lidroid.xutils.db.sqlite.WhereBuilder having;

    private com.lidroid.xutils.db.sqlite.Selector selector;

    private DbModelSelector(Class<?> entityType) {
        selector = com.lidroid.xutils.db.sqlite.Selector.from(entityType);
    }

    protected DbModelSelector(com.lidroid.xutils.db.sqlite.Selector selector, String groupByColumnName) {
        this.selector = selector;
        this.groupByColumnName = groupByColumnName;
    }

    protected DbModelSelector(com.lidroid.xutils.db.sqlite.Selector selector, String[] columnExpressions) {
        this.selector = selector;
    ...
    public DbModelSelector where(com.lidroid.xutils.db.sqlite.WhereBuilder whereBuilder) {
    ...
    public DbModelSelector and(com.lidroid.xutils.db.sqlite.WhereBuilder where) {
        selector.and(where);
        return this;
    }
    ...
    public DbModelSelector or(com.lidroid.xutils.db.sqlite.WhereBuilder where) {
        selector.or(where);
        return this;
    }
