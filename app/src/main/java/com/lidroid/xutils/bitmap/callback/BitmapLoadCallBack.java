...
public abstract class BitmapLoadCallBack<T extends View> {
     ...
     * @param config
     */
    public abstract void onLoadCompleted(T container, String uri, Bitmap bitmap, BitmapDisplayConfig config, com.lidroid.xutils.bitmap.callback.BitmapLoadFrom from);
    ...
    private com.lidroid.xutils.bitmap.callback.BitmapSetter<T> bitmapSetter;
