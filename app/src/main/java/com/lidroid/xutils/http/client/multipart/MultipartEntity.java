...
public class MultipartEntity implements HttpEntity, UploadEntity {
    ...
    private final com.lidroid.xutils.http.client.multipart.HttpMultipart multipart;
    ...
    public MultipartEntity(
        ...
        this.multipart = new com.lidroid.xutils.http.client.multipart.HttpMultipart(multipartSubtype, this.charset, this.boundary, mode);
    ...
    public void addPart(final com.lidroid.xutils.http.client.multipart.FormBodyPart bodyPart) {
        this.multipart.addBodyPart(bodyPart);
        this.dirty = true;
    }

    public void addPart(final String name, final ContentBody contentBody) {
        addPart(new com.lidroid.xutils.http.client.multipart.FormBodyPart(name, contentBody));
    }

    public void addPart(final String name, final ContentBody contentBody, final String contentDisposition) {
        addPart(new com.lidroid.xutils.http.client.multipart.FormBodyPart(name, contentBody, contentDisposition));
    }
