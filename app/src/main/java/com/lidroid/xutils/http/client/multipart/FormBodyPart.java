...
public class FormBodyPart {
    ...
    public FormBodyPart(final String name, final ContentBody body, final String contentDisposition) {
        ...
        if (contentDisposition != null) {
            addField(com.lidroid.xutils.http.client.multipart.MIME.CONTENT_DISPOSITION, contentDisposition);
        } else {
            generateContentDisposition(body);
        }
        generateContentType(body);
    ...
    protected void generateContentDisposition(final ContentBody body) {
        ...
        addField(com.lidroid.xutils.http.client.multipart.MIME.CONTENT_DISPOSITION, buffer.toString());
    }
    ...
    protected void generateContentType(final ContentBody body) {
        ...
        addField(com.lidroid.xutils.http.client.multipart.MIME.CONTENT_TYPE, buffer.toString());
    }

    protected void generateTransferEncoding(final ContentBody body) {
        addField(com.lidroid.xutils.http.client.multipart.MIME.CONTENT_TRANSFER_ENC, body.getTransferEncoding()); // TE cannot be null
    }
