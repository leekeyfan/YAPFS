...
class Node<T> {
    ...
    private com.lidroid.xutils.task.PriorityObject<?> value;
    Node<T> next;
    ...
    public void setValue(T value) {
        if (value == null) {
            this.value = null;
        } else if (value instanceof com.lidroid.xutils.task.PriorityObject) {
            this.value = (com.lidroid.xutils.task.PriorityObject<?>) value;
            this.valueAsT = true;
        } else {
            this.value = new com.lidroid.xutils.task.PriorityObject<T>(Priority.DEFAULT, value);
        }
    }
}
