...
public abstract class PriorityAsyncTask<Params, Progress, Result> implements com.lidroid.xutils.task.TaskHandler {
    ...
    public void setPriority(com.lidroid.xutils.task.Priority priority) {
    ...
    public final PriorityAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
        ...
        exec.execute(new com.lidroid.xutils.task.PriorityRunnable(priority, mFuture));
    ...
    public static void execute(Runnable runnable) {
        execute(runnable, com.lidroid.xutils.task.Priority.DEFAULT);
    }
