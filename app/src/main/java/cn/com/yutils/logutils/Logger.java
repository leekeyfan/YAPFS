package cn.com.yutils.logutils;
...
import cn.com.yutils.logutils.utils.ArrayUtil;
import cn.com.yutils.logutils.utils.SystemUtil;
...
public final class Logger implements Printer {
	...
	private String generateTag(StackTraceElement caller) {
		...
		callerClazzName = callerClazzName.substring(callerClazzName
				.lastIndexOf(".") + 1);
		String Prefix = TextUtils.isEmpty(callerClazzName) ? ""
				: callerClazzName;
